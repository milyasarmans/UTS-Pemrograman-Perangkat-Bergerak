...
public class MainPantaiGigiHiu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_pantai_gigi_hiu);
    ...
    public void Bayar(View view) {
        ...
        Intent intent = new Intent(MainPantaiGigiHiu.this, MainTHPGH.class);
