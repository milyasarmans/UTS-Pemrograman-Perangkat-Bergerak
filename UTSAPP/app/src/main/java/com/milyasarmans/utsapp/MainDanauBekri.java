...
public class MainDanauBekri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_danau_bekri);
    ...
    public void Bayar(View view) {
        ...
        Intent intent = new Intent(MainDanauBekri.this, MainTHDB.class);
